...
This plugin version uses a special Android NDK sqlite database access library (C-language implementation), with premium premium improvements to the internal JSON interface between the Javascript and native Android implementation, to provide significant performance and memory usage improvements on the Android platform.
